...
import net.spals.appbuilder.nosqlstore.core.model.TwoValueRangeKey.TwoValueHolder;
 ...
 * @author tkral
 */
@AutoBindInMap(baseClass = NoSqlStorePlugin.class, key = "local")
class MapDBNoSqlStorePlugin implements NoSqlStorePlugin {

    private final ObjectMapper objectMapper = new ObjectMapper();
    private final DB mapDB;

    MapDBNoSqlStorePlugin(final DB mapDB) {
        this.mapDB = mapDB;
    }
    ...
    @VisibleForTesting
    Object[] convertSimpleKeyToArray(final NoSqlStoreKey key) {
    ...
    @VisibleForTesting
    BTreeMap<Object[], byte[]> getTable(final String tableName, final NoSqlStoreKey key) {
    ...
    @VisibleForTesting
    Comparator<Map<String, Object>> valueComparator(final NoSqlStoreKey key) {
        return (m1, m2) -> {
