 ...
 */
@AutoValue
public abstract class TwoValueRangeKey<C extends Comparable<C>> implements NoSqlStoreRangeKey<TwoValueHolder<C>> {

    public static <C extends Comparable<C>> NoSqlStoreRangeKey<TwoValueHolder<C>> between(final C value1, final C value2) {
